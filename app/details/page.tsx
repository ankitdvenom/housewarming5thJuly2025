      ...
      <div className="max-w-2xl mx-auto text-center">
        ...
        <details className="border rounded p-4 mb-6">
          ...
          <div className="mt-4 space-y-3 text-left text-sm">
            <p>
              🕓 <strong>16:00 – 17:00 | WELCOME & SOCIAL START</strong><br/>
              🍹 Welcome Drinks Station<br/>
              📸 Polaroid Photo Booth – Snap a pic, capture the moment 📸😉
            </p>
            <p>
              🕔 <strong>17:00 – 18:00 | GRILL + Fun Challenges</strong><br/>
              🔥 Grill Opens (weather permitting) – We'll have hotdogs & sausages, feel free to bring your favourites 🌭<br/>
              🧠 Fun Challenges – buckle up 💪🤫
            </p>
            <p>
              🕕 <strong>18:00 – 18:30 | KAHOOT Time</strong><br/>
              👩‍💻 A quick game of Kahoot 📱🤙
            </p>
            <p>
              🕡 <strong>18:30 – 20:00 | SAUNA TIME</strong><br/>
              🧖‍♀️ Sauna available for those joining (Don't forget to bring your swimwear and towels) 👙🤩
            </p>
            <p>
              🕖 <strong>19:00 – 20:30 | BEERPONG + CHILL VIBES</strong><br/>
              🍻 What’s a party without Beerpong?<br/>
              🏆 Other games like flip cup, bus, kings cup suggested 🎉
            </p>
            <p>
              🕣 <strong>20:30 – 22:00 | DRINKING GAMES + PARTY MODE</strong><br/>
              🎵 Continue drinking games, enjoy food, and put on your dancing shoes 🕺🪩
            </p>
            <p>
              🕥 <strong>22:30+ | AFTERPARTY / GOING OUT</strong><br/>
              🤩 Those who want to go out start heading out ❤️
            </p>
            <p>👩‍🍼 Mama & Siya go to bed soon after 😴😛</p>
            <p>
              🍱 <strong>Food:</strong> We will have a couple of appetizers, sweet & savoury 🥕🌽🥒🍩🥯🧀
            </p>
            <p>
              🍻 <strong>Drinks:</strong> Some drinks provided, feel free to bring your own 🥃🍸
            </p>
            <p>
              🤩 Bring in your party energy, good vibes and don't forget to dress up in summer shades of
              <span className="font-semibold" style={{ color: "orange" }}> orange</span>,
              <span className="font-semibold" style={{ color: "green" }}> green</span>, and
        ...
        <div className="mb-8">
          ...
          <p>
            Your presence is what truly matters to us, and gifts are completely optional. Many friends asked about it,
            so we’re sharing a wishlist here just in case you’d like some ideas.
            If you wish, feel free to team up with others and contribute together.
            But most of all, we’d love to just have you with us!
          </p>
          <a
